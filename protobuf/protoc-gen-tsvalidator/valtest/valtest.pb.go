...
type ValTestMessage struct {
	...
	// validate the min length (max length defaults to current default string len
	// (130))
	...
	// allow additional characters including # as part of the restricted chars
	// list (should be replaced by replace_unsafe)
	...
	// this is an example of a definition that will allow many characters but
	// still will replace unsafe chars normally, definitions like this should be
	// avoided as it is unlikely that it will match your data requirements
	// however, as a starting point, with these settings it is very unlikely that
	// user input is rejected unless it is malformed
...
var file_valtest_proto_rawDesc = []byte{
	...
	0x6f, 0x63, 0x2d, 0x67, 0x65, 0x6e, 0x2d, 0x74, 0x73, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74,
