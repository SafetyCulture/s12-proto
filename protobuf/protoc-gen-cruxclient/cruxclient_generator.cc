...
void PrintHeaderClasses(Printer *printer, const FileDescriptor *file) {
  std::map<string, string> vars;
...
void PrintHeaderEpilogue(Printer *printer, const FileDescriptor *file) {
  ...
  printer->Print(vars,
                 "#endif  // GRPC_SERVICE_$filename_identifier$__INCLUDED\n");
}
...
class Generator : public CodeGenerator {
 public:
  ...
  bool Generate(const FileDescriptor *file, const string &parameter,
    ...
    PrintHeaderClasses(&header_printer, file);
