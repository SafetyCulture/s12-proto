...
class Rectangle final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::routeguide::v1::Point* release_lo();
  ...
  PROTOBUF_MUST_USE_RESULT ::routeguide::v1::Point* release_hi();
...
class Feature final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::routeguide::v1::Point* release_location();
...
class RouteSummary_Details_MoreDetails final :
 ...
 public:
  ...
  explicit constexpr RouteSummary_Details_MoreDetails(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline RouteSummary_Details_MoreDetails* New() const final {
    return new RouteSummary_Details_MoreDetails();
  }
...
class RouteSummary_Details final :
 ...
 public:
  ...
  explicit constexpr RouteSummary_Details(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline RouteSummary_Details* New() const final {
    return new RouteSummary_Details();
  }
  ...
  PROTOBUF_MUST_USE_RESULT ::routeguide::v1::RouteSummary_Details_MoreDetails* release_details();
...
public:
  ...
  explicit constexpr RouteSummary_DetailsMapEntry_DoNotUse(
...
class RouteSummary final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::routeguide::v1::RouteSummary_Details* release_details();
...
inline void Rectangle::set_allocated_lo(::routeguide::v1::Point* lo) {
  ...
  if (lo) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::routeguide::v1::Point>::GetOwningArena(lo);
...
inline void Rectangle::set_allocated_hi(::routeguide::v1::Point* hi) {
  ...
  if (hi) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::routeguide::v1::Point>::GetOwningArena(hi);
    if (message_arena != submessage_arena) {
...
inline void Feature::set_allocated_location(::routeguide::v1::Point* location) {
  ...
  if (location) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::routeguide::v1::Point>::GetOwningArena(location);
    if (message_arena != submessage_arena) {
...
inline void RouteSummary_Details::set_allocated_details(::routeguide::v1::RouteSummary_Details_MoreDetails* details) {
  ...
  if (details) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::routeguide::v1::RouteSummary_Details_MoreDetails>::GetOwningArena(details);
    if (message_arena != submessage_arena) {
...
inline void RouteSummary::set_allocated_details(::routeguide::v1::RouteSummary_Details* details) {
  ...
  if (details) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::routeguide::v1::RouteSummary_Details>::GetOwningArena(details);
    if (message_arena != submessage_arena) {
      details = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, details, submessage_arena);
    }
...
RouteSummary::_internal_mutable_details_map() {
  return details_map_.MutableMap();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::routeguide::v1::RouteSummary_Details >*
