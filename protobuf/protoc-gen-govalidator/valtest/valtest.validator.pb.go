...
func (m *ValTestMessage) Validate() error {
	...
	if m.OptionalString != nil {
		...
		if !_regex_d4db71516b8749dc594e5bf604c6a110.MatchString(*m.OptionalString) {
	...
	if m.LongString != "" {
		...
		if !_regex_1bb1e0a2437db38577f49b4f31ccfca2.MatchString(m.LongString) {
...
func (m *SimpleStringMessage) Validate() error {
	...
	if !_regex_d4db71516b8749dc594e5bf604c6a110.MatchString(m.Both) {
