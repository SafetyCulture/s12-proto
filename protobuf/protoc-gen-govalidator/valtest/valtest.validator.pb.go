...
func (m *ValTestMessage) Validate() error {
	...
	if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.Description) {
	...
	if !_regex_e4c44fde13be339dd5604dd7b59ce2a9.MatchString(m.Password) {
	...
	if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.Title) {
	...
	if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.FixedString) {
	...
	if !_regex_0ab6984db999830b7d4afe86b2992e8d.MatchString(m.RuneString) {
	...
	if !_regex_5637686d84a011d9d453fc7646becfdb.MatchString(m.ReplaceString) {
	...
	if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.NotReplaceString) {
	...
	if !_regex_45db92d23fba83936ffc316f065ec9ef.MatchString(m.AllowString) {
	...
	if !_regex_ba79e7fa5687371a0963e930644eef34.MatchString(m.SymbolString) {
	...
	if !_regex_8978ed7857aea3d65c11e428eb73648c.MatchString(m.SymbolsString) {
	...
	if !_regex_4d7919a5607667383c9af11c97dc4adc.MatchString(m.NewlineString) {
	...
	if !_regex_d19d310eec45a88a08d0f2edb0aa1bbc.MatchString(m.InvalidEncodingString) {
	...
	if m.OptString != "" {
		...
		if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.OptString) {
	...
	if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.TrimString) {
	...
	if !_regex_8b0c84b6c24a9e58f4a3e533e7a20686.MatchString(m.AllString) {
	...
	if m.Name != "" {
		...
		if !_regex_274229a1dc2d74bd1e7bdff228637100.MatchString(m.Name) {
	...
	if m.ScTitle != "" {
		...
		if !_regex_5637686d84a011d9d453fc7646becfdb.MatchString(m.ScTitle) {
	...
	if m.ScPermissive != "" {
		...
		if !_regex_c6f6be250badbf895edae09a4a62a394.MatchString(m.ScPermissive) {
	...
	if m.NotSanitisePua != "" {
		...
		if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.NotSanitisePua) {
	...
	if m.SanitisePua != "" {
		...
		if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.SanitisePua) {
	...
	if m.SanitiseLength != "" {
		...
		if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.SanitiseLength) {
			return fmt.Errorf(`sanitise_length: value must only have valid characters`)
		}
	}
	if m.OptionalString != nil {
		if !norm.NFC.IsNormalString(*m.OptionalString) && norm.NFD.IsNormalString(*m.OptionalString) {
			// normalise NFD to NFC string
			var normErr error
			*m.OptionalString, _, normErr = transform.String(transform.Chain(norm.NFD, norm.NFC), *m.OptionalString)
			if normErr != nil {
				return fmt.Errorf(`optional_string: value must must be normalisable to NFC`)
			}
		}
		if strings.ContainsRune(*m.OptionalString, utf8.RuneError) {
			return fmt.Errorf(`optional_string: value must must have valid encoding`)
		...
		if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(*m.OptionalString) {
			return fmt.Errorf(`optional_string: value must only have valid characters`)
		}
	}
	if x, ok := m.ContactOneof.(*ValTestMessage_Phone); ok {
		...
		if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(x.Phone) {
	...
	if m.AllId != "" {
		if !proto.IsUUIDv4(m.AllId) {
			...
			if !isValidId && proto.IsLongPrefixedLegacyID(m.AllId) {
				isValidId = true
			}
			if !isValidId {
	...
	if m.LongString != "" {
		if !norm.NFC.IsNormalString(m.LongString) && norm.NFD.IsNormalString(m.LongString) {
			// normalise NFD to NFC string
			var normErr error
			m.LongString, _, normErr = transform.String(transform.Chain(norm.NFD, norm.NFC), m.LongString)
			if normErr != nil {
				return fmt.Errorf(`long_string: value must must be normalisable to NFC`)
			}
		}
		if strings.ContainsRune(m.LongString, utf8.RuneError) {
			return fmt.Errorf(`long_string: value must must have valid encoding`)
		...
		if !_regex_b831aaa8c1be89636106f6fc881690db.MatchString(m.LongString) {
	...
	if m.StringWithPrefix != "" {
		...
		if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.StringWithPrefix) {
			return fmt.Errorf(`string_with_prefix: value must only have valid characters`)
		}
	}
	if !proto.IsValidEmail(m.Username, false) {
		isValidUsername := false
		if proto.IsValidNonEmail(m.Username) {
			isValidUsername = true
		}
		if !isValidUsername {
			return fmt.Errorf(`username: value must be a valid email address or username`)
		}
	}
	if m.UsernameOptional != "" {
		if !proto.IsValidEmail(m.UsernameOptional, false) {
			isValidUsername := false
			if proto.IsValidNonEmail(m.UsernameOptional) {
				isValidUsername = true
			}
			if !isValidUsername {
				return fmt.Errorf(`username_optional: value must be a valid email address or username`)
			}
		}
	}
	if !proto.IsValidEmail(m.UsernameEmailOnly, false) {
		isValidUsername := false
		if !isValidUsername {
			return fmt.Errorf(`username_email_only: value must be a valid email address or username`)
		}
	}
	if !proto.IsValidEmail(m.UsernameLogOnly, false) {
		isValidUsername := false
		if proto.IsValidNonEmail(m.UsernameLogOnly) {
			isValidUsername = true
		}
		if !isValidUsername {
			fmt.Printf("[log-only] %s: value must be %s: Base64Encoded input: %s\n", "username_log_only", "be a valid email address or username", proto.Base64Encode(proto.FirstCharactersFromString(fmt.Sprintf("%v", m.UsernameLogOnly), 50)))
		}
	}
	if m.UsernameOptionalEmailOnly != "" {
		if !proto.IsValidEmail(m.UsernameOptionalEmailOnly, false) {
			isValidUsername := false
			if !isValidUsername {
				return fmt.Errorf(`username_optional_email_only: value must be a valid email address or username`)
			}
		}
	}
	if m.UsernameOptionalLogOnly != "" {
		if !proto.IsValidEmail(m.UsernameOptionalLogOnly, false) {
			isValidUsername := false
			if proto.IsValidNonEmail(m.UsernameOptionalLogOnly) {
				isValidUsername = true
			}
			if !isValidUsername {
				fmt.Printf("[log-only] %s: value must be %s: Base64Encoded input: %s\n", "username_optional_log_only", "be a valid email address or username", proto.Base64Encode(proto.FirstCharactersFromString(fmt.Sprintf("%v", m.UsernameOptionalLogOnly), 50)))
			}
		}
	}
	if !proto.IsValidEmail(m.UsernameEmailOnlyLogOnly, false) {
		isValidUsername := false
		if !isValidUsername {
			fmt.Printf("[log-only] %s: value must be %s: Base64Encoded input: %s\n", "username_email_only_log_only", "be a valid email address or username", proto.Base64Encode(proto.FirstCharactersFromString(fmt.Sprintf("%v", m.UsernameEmailOnlyLogOnly), 50)))
		}
	}
	if m.UsernameAllFlags != "" {
		if !proto.IsValidEmail(m.UsernameAllFlags, false) {
			isValidUsername := false
			if !isValidUsername {
				fmt.Printf("[log-only] %s: value must be %s: Base64Encoded input: %s\n", "username_all_flags", "be a valid email address or username", proto.Base64Encode(proto.FirstCharactersFromString(fmt.Sprintf("%v", m.UsernameAllFlags), 50)))
			}
		}
	}
...
func (m *ValTestMessage_NestedMessage) Validate() error {
	...
	if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.Val) {
...
func (m *ValTestMessage_NestedMessage_InnerNestedMessage) Validate() error {
	...
	if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.InnerVal) {
...
func (m *LogOnlyValidationMessage) Validate() error {
	...
	if !proto.IsUUIDv4(m.ImageId) {
		...
		if !isValidId && proto.IsLongPrefixedLegacyID(m.ImageId) {
			isValidId = true
		}
		if !isValidId {
	...
	if !proto.IsUUIDv4(m.InspectionId) {
		...
		if !isValidId && proto.IsLongPrefixedLegacyID(m.InspectionId) {
			isValidId = true
		}
		if !isValidId {
	...
	if !proto.IsUUIDv4(m.OwnerId) {
		...
		if !isValidId && proto.IsLongPrefixedLegacyID(m.OwnerId) {
			isValidId = true
		}
		if !isValidId {
	...
	if m.Title != "" {
		...
		if !_regex_2f80c332d17a7d34ff052869a008509d.MatchString(m.Title) {
	...
	if !_regex_9f50aef256c28e02cdfc26ef24d41fe4.MatchString(m.Name) {
		return fmt.Errorf(`name: value must only have valid characters`)
	}
	if m.Latitude != 0 {
...
func (m *NestedLevel3Message) Validate() error {
	...
	if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.OrgId5) {
...
func (m *NestedLevel2Message) Validate() error {
	...
	if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.OrgId4) {
...
func (m *NestedLevel1Message) Validate() error {
	...
	if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.OrgId3) {
...
func (m *MyReqMessage) Validate() error {
	...
	if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.UserId) {
...
func (m *NonUrlMessage) Validate() error {
	if m.RejectUrlTest != "" {
		...
		if !_regex_b831aaa8c1be89636106f6fc881690db.MatchString(m.RejectUrlTest) {
	...
	if m.BreakPartialUrlTest != "" {
		...
		if !_regex_b831aaa8c1be89636106f6fc881690db.MatchString(m.BreakPartialUrlTest) {
...
func (m *SimpleStringMessage) Validate() error {
	var _slen_SimpleStringMessage_SubjectToken = utf8.RuneCountInString(m.SubjectToken)
	if _slen_SimpleStringMessage_SubjectToken > 8192 || _slen_SimpleStringMessage_SubjectToken < 1 {
		return fmt.Errorf(`subject_token: value must have a length between 1 and 8192`)
	}
	var _slen_SimpleStringMessage_Audience = utf8.RuneCountInString(m.Audience)
	if _slen_SimpleStringMessage_Audience > 253 || _slen_SimpleStringMessage_Audience < 1 {
		return fmt.Errorf(`audience: value must have a length between 1 and 253`)
	}
	if m.Note != "" {
		var _slen_SimpleStringMessage_Note = utf8.RuneCountInString(m.Note)
		if _slen_SimpleStringMessage_Note > 40 || _slen_SimpleStringMessage_Note < 5 {
			return fmt.Errorf(`note: value must have a length between 5 and 40`)
		}
	}
	if !norm.NFC.IsNormalString(m.Both) && norm.NFD.IsNormalString(m.Both) {
		// normalise NFD to NFC string
		var normErr error
		m.Both, _, normErr = transform.String(transform.Chain(norm.NFD, norm.NFC), m.Both)
		if normErr != nil {
			return fmt.Errorf(`both: value must must be normalisable to NFC`)
		}
	}
	if strings.ContainsRune(m.Both, utf8.RuneError) {
		return fmt.Errorf(`both: value must must have valid encoding`)
	...
	if !_regex_dacd7d349b42e34a5ce4fbd057f04d72.MatchString(m.Both) {
		return fmt.Errorf(`both: value must only have valid characters`)
	}
	var _slen_SimpleStringMessage_Both = utf8.RuneCountInString(m.Both)
	if _slen_SimpleStringMessage_Both > 100 || _slen_SimpleStringMessage_Both < 1 {
		return fmt.Errorf(`both: value must have a length between 1 and 100`)
	}
	return nil
}
