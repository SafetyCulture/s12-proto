...
const _regex_val_9b0e005c3d3ca41f13e949f82315d0ea = `^[\pL\pN\p{So}\x{0020}\x{0028}\x{0029}\x{002C}\x{002E}\x{003A}\x{003F}\x{0040}\x{005B}\x{005D}\x{005F}\x{00BF}\x{200D}\x{2013}]+$`

var _regex_9b0e005c3d3ca41f13e949f82315d0ea = regexp.MustCompile(_regex_val_9b0e005c3d3ca41f13e949f82315d0ea)
...
const _regex_val_11f4076e31d466e7cf1fc9673d9f03ab = `^[\pL\pN\p{Sc}\x{0020}\x{0028}\x{0029}\x{002C}\x{002E}\x{003A}\x{003F}\x{0040}\x{005B}\x{005D}\x{005F}\x{00BF}\x{2013}]+$`

var _regex_11f4076e31d466e7cf1fc9673d9f03ab = regexp.MustCompile(_regex_val_11f4076e31d466e7cf1fc9673d9f03ab)

// Pattern for ValTestMessage_SymbolsString
const _regex_val_0f80c58ab03bb6e8caae9c68c51d76db = `^[\pL\pM\pN\p{So}\x{0020}\x{0028}\x{0029}\x{002C}\x{002E}\x{003A}\x{003F}\x{0040}\x{005B}\x{005D}\x{005F}\x{00BF}\x{200D}\x{2013}]+$`

var _regex_0f80c58ab03bb6e8caae9c68c51d76db = regexp.MustCompile(_regex_val_0f80c58ab03bb6e8caae9c68c51d76db)
...
const _regex_val_b485197b8d1355c20eba7c260bbd05ea = `^[\pL\pM\pN\p{Po}\p{Sc}\p{Sk}\p{Sm}\p{So}\x{0020}\x{0028}\x{0029}\x{002C}\x{002E}\x{003A}\x{003F}\x{0040}\x{005B}\x{005D}\x{005F}\x{007E}\x{00BF}\x{02C3}\x{104B}\x{200D}\x{2013}\x{2018}\x{2019}\x{201C}\x{201D}\x{2022}\x{FFFD}}]+$`

var _regex_b485197b8d1355c20eba7c260bbd05ea = regexp.MustCompile(_regex_val_b485197b8d1355c20eba7c260bbd05ea)
...
const _regex_val_4d2b5c7c5e197a16ab37d11fa8afa90d = `^[\pL\pM\pN\p{Po}\p{Sc}\p{Sk}\p{Sm}\p{So}\x{0020}\x{0028}\x{0029}\x{002C}\x{002E}\x{003A}\x{003F}\x{0040}\x{005B}\x{005D}\x{005F}\x{007E}\x{00BF}\x{02C2}\x{02C3}\x{037E}\x{104B}\x{200D}\x{2013}\x{2018}\x{2019}\x{201C}\x{201D}\x{2022}\x{2052}\x{2212}\x{2215}\x{2217}\x{2E40}\x{FF01}\x{FF0B}\x{FF3C}\x{FFE8}}]+$`

var _regex_4d2b5c7c5e197a16ab37d11fa8afa90d = regexp.MustCompile(_regex_val_4d2b5c7c5e197a16ab37d11fa8afa90d)
...
const _regex_val_ea1d2538ac1789ea8b13ba298756128c = `^[\pL\pM\pN\p{Po}\p{Sc}\p{Sk}\p{Sm}\p{So}\x{0020}\x{0021}\x{0022}\x{0023}\x{0025}\x{0026}\x{0027}\x{0028}\x{0029}\x{002A}\x{002C}\x{002D}\x{002E}\x{002F}\x{003A}\x{003F}\x{0040}\x{005B}\x{005C}\x{005D}\x{005F}\x{007E}\x{00BF}\x{104B}\x{200D}\x{2013}\x{2018}\x{2019}\x{201C}\x{201D}\x{2022}]+$`

var _regex_ea1d2538ac1789ea8b13ba298756128c = regexp.MustCompile(_regex_val_ea1d2538ac1789ea8b13ba298756128c)
