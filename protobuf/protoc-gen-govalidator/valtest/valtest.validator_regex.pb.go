...
// Pattern for AuthCallbackRequest_RawState
const _regex_val_49c3af0ba56ba5365f6aa218eec1b288 = `^[\pL\pN\x{0020}\x{0021}\x{0022}\x{0023}\x{0025}\x{0026}\x{0027}\x{0028}\x{0029}\x{002A}\x{002B}\x{002C}\x{002D}\x{002E}\x{002F}\x{003A}\x{003D}\x{003F}\x{0040}\x{005B}\x{005C}\x{005D}\x{005F}\x{00BF}\x{2013}]+$`

var _regex_49c3af0ba56ba5365f6aa218eec1b288 = regexp.MustCompile(_regex_val_49c3af0ba56ba5365f6aa218eec1b288)

// AuthCallbackRequest_ErrorMsg is using regex d4db71516b8749dc594e5bf604c6a110
// AuthCallbackRequest_TrueClientIp is using regex d4db71516b8749dc594e5bf604c6a110
// Pattern for AuthCallbackRequest_UserAgent
const _regex_val_b41c4bf2e7e101d6798b2df73dbde440 = `^[\pL\pN\x{0020}\x{0021}\x{0022}\x{0023}\x{0025}\x{0026}\x{0027}\x{0028}\x{0029}\x{002A}\x{002C}\x{002D}\x{002E}\x{002F}\x{003A}\x{003B}\x{003F}\x{0040}\x{005B}\x{005C}\x{005D}\x{005F}\x{00BF}\x{2013}]+$`

var _regex_b41c4bf2e7e101d6798b2df73dbde440 = regexp.MustCompile(_regex_val_b41c4bf2e7e101d6798b2df73dbde440)
