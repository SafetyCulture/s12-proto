...
const _regex_val_09b6a9f7d69de2921c44cc9f2582dc11 = `^[\pL\pN\x{0009}\x{0020}\x{0021}\x{0022}\x{0023}\x{0024}\x{0025}\x{0026}\x{0027}\x{0028}\x{0029}\x{002A}\x{002B}\x{002C}\x{002D}\x{002E}\x{002F}\x{003A}\x{003B}\x{003C}\x{003D}\x{003E}\x{003F}\x{0040}\x{005B}\x{005C}\x{005D}\x{005E}\x{005F}\x{0060}\x{007B}\x{007C}\x{007D}\x{007E}\x{00BF}\x{2013}]+$`

var _regex_09b6a9f7d69de2921c44cc9f2582dc11 = regexp.MustCompile(_regex_val_09b6a9f7d69de2921c44cc9f2582dc11)
...
const _regex_val_1c9a7c333585d465fa7363aa729f2911 = `^[\pL\pN\x{0009}\x{000A}\x{0020}\x{0021}\x{0022}\x{0023}\x{0025}\x{0026}\x{0027}\x{0028}\x{0029}\x{002A}\x{002C}\x{002D}\x{002E}\x{002F}\x{003A}\x{003F}\x{0040}\x{005B}\x{005C}\x{005D}\x{005F}\x{00BF}\x{2013}]+$`

var _regex_1c9a7c333585d465fa7363aa729f2911 = regexp.MustCompile(_regex_val_1c9a7c333585d465fa7363aa729f2911)

// Pattern for LogOnlyValidationMessage_Name
const _regex_val_e4c46a1e3eaaae755227ba1a59497c3d = `^[\pL\pM\pN\pPo\pSc\pSk\pSm\pSo\x{0009}\x{0020}\x{0021}\x{0022}\x{0023}\x{0025}\x{0026}\x{0027}\x{0028}\x{0029}\x{002A}\x{002C}\x{002D}\x{002E}\x{002F}\x{003A}\x{003F}\x{0040}\x{005B}\x{005C}\x{005D}\x{005F}\x{007E}\x{00BF}\x{104B}\x{200D}\x{2013}\x{2018}\x{2019}\x{201C}\x{201D}\x{2022}]+$`

var _regex_e4c46a1e3eaaae755227ba1a59497c3d = regexp.MustCompile(_regex_val_e4c46a1e3eaaae755227ba1a59497c3d)

// LogOnlyValidationMessage_Answer is using regex e4c46a1e3eaaae755227ba1a59497c3d
// Pattern for LogOnlyValidationMessage_Note
const _regex_val_56b61c17208942cd7fb89ac222d5f0a2 = `^[\pL\pM\pN\pPo\pSc\pSk\pSm\pSo\x{0009}\x{000A}\x{0020}\x{0021}\x{0022}\x{0023}\x{0025}\x{0026}\x{0027}\x{0028}\x{0029}\x{002A}\x{002C}\x{002D}\x{002E}\x{002F}\x{003A}\x{003F}\x{0040}\x{005B}\x{005C}\x{005D}\x{005F}\x{007E}\x{00BF}\x{104B}\x{200D}\x{2013}\x{2018}\x{2019}\x{201C}\x{201D}\x{2022}]+$`

var _regex_56b61c17208942cd7fb89ac222d5f0a2 = regexp.MustCompile(_regex_val_56b61c17208942cd7fb89ac222d5f0a2)
