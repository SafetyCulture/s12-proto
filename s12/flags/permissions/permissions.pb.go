...
var file_s12_flags_permissions_permissions_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		ExtensionType: ([]string)(nil),
		Field:         20101,
		Name:          "s12.flags.permissions.required_scopes",
		Tag:           "bytes,20101,rep,name=required_scopes",
		Filename:      "s12/flags/permissions/permissions.proto",
	},
}
...
var (
	...
	// A list of required scopes for the given method.
	// For example:
	//
	//	rpc Getuser(Request) returns (Response) {
	//	  option (s12.flags.permissions.required_scopes) = "admin"
	//	}
	//
	// repeated string required_scopes = 20101;
	E_RequiredScopes = &file_s12_flags_permissions_permissions_proto_extTypes[1]
)
...
var file_s12_flags_permissions_permissions_proto_rawDesc = []byte{
	...
	0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x46, 0x6c, 0x61, 0x67, 0x73, 0x3a, 0x49, 0x0a, 0x0f, 0x72,
	...
	0x9d, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64,
	0x53, 0x63, 0x6f, 0x70, 0x65, 0x73, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x53, 0x61, 0x66, 0x65, 0x74, 0x79, 0x43, 0x75, 0x6c, 0x74, 0x75,
	0x72, 0x65, 0x2f, 0x73, 0x31, 0x32, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x31, 0x32,
	0x2f, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x2f, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x73,
}
...
var file_s12_flags_permissions_permissions_proto_depIdxs = []int32{
	...
	0, // 1: s12.flags.permissions.required_scopes:extendee -> google.protobuf.MethodOptions
