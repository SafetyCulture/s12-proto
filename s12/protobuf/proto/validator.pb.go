...
type StringRules struct {
	...
	//
	// URLs must be full URLs, including scheme, partial URLs will be ignored.
	// For example: "Click on http://evil.com/scam for more stuff" will return an error, but "Come and see
	// let-me-steal-your-info.org for free things" will not (missing scheme)
	RejectUrl *bool `protobuf:"varint,13,opt,name=reject_url,json=rejectUrl,def=0" json:"reject_url,omitempty"`
	// Partial URLs present anywhere in the field will be REPLACED (broken) with a sanitised version. Will NOT return
	// an error.
	//
...
func file_s12_protobuf_proto_validator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_s12_protobuf_proto_validator_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_s12_protobuf_proto_validator_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
